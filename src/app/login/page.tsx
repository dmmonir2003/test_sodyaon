...
export default function LoginPage() {
  ...
  const handleSocialLogin = async (provider: string) => {
    try {
      const response = await loginProfile({ email: `social_${provider}@dummy.com`, password: "social_dummy" }).unwrap();
      dispatch(setCredentials({ user: response.user, token: response.token }));
      router.push("/profile");
    } catch (err) {
    ...
    <div className="min-h-screen flex text-slate-900 dark:text-white bg-slate-50 dark:bg-slate-900">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12">
        <div className="max-w-md w-full mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-black font-heading mb-2">স্বাগতম!</h1>
          <p className="text-slate-500 mb-8">প্লেটাইমে আবার ফিরে আসার জন্য ধন্যবাদ। আপনার অ্যাকাউন্টে লগইন করুন।</p>
          ...
          <form onSubmit={handleLogin} className="space-y-4 mb-8">
            <div>
              ...
              <div className="relative flex">
                ...
                <input 
                  ...
                  required
                  placeholder={loginMethod === "phone" ? "1XXXXXXXXX" : "your@email.com"} 
                  value={identifier}
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <Link href="/forgot-password" className="flex-shrink-0 text-sm text-primary-600 font-bold hover:text-primary-800 transition-colors">পাসওয়ার্ড ভুলে গেছেন?</Link>
              </div>
            ...
            >
              {isLoading ? "অপেক্ষা করুন..." : "লগইন করুন"} <ArrowRight className="w-5 h-5" />
            </button>
          </form>

          <p className="text-center text-slate-500 font-medium">
            একাউন্ট নেই? <Link href="/register" className="text-primary-600 font-bold underline ml-1">রেজিস্টার করুন</Link>
          </p>
      ...
      <div className="hidden lg:flex w-1/2 bg-indigo-50 dark:bg-slate-800 relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="max-w-lg z-10 text-center">
          <h2 className="text-4xl font-black font-heading text-slate-900 dark:text-white mb-6">চাইল্ড প্রোফাইল তৈরি করুন</h2>
          <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
            প্লেটাইম একাউন্ট তৈরি করলে আপনি এআই গিফট ফাইন্ডার এক্সেস পাবেন। আপনার সন্তানের বয়স এবং পছন্দের বিষয় সংরক্ষণ করুন, আর স্বয়ংক্রিয়ভাবে প্রতিটি জন্মদিনে দারুণ খেলনার সুপারিশ পান।
          </p>
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:-translate-y-1 transition-transform">
              ...
              <h3 className="font-bold text-slate-900 dark:text-white">স্মার্ট ম্যাচ</h3>
            </div>
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:-translate-y-1 transition-transform">
              <span className="text-3xl mb-2 block">🎂</span>
              <h3 className="font-bold text-slate-900 dark:text-white">জন্মদিন রিমাইন্ডার</h3>
            </div>
          </div>
        </div>
      </div>
