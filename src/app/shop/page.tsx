...
// export const metadata: Metadata = {
//   title: "সব খেলনা দেখুন | দারুণ দারুণ খেলনা আবিষ্কার করুন",
//   description: "শিশুদের সকল বয়সের জন্য মজাদার এবং শিক্ষামূলক খেলনার আমাদের বিস্তৃত সংগ্রহ ব্রাউজ করুন। সেরা উপহারটি খুঁজুন আজই।",
// };
          ...
          <div className="flex-1">
            ...
            <div className="mt-12 flex justify-center">
              <div className="inline-flex gap-2">
                ...
                <button className="w-10 h-10 rounded-xl bg-primary-600 text-white font-bold shadow-md">१</button>
                <button className="w-10 h-10 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-primary-400 hover:text-primary-600 font-medium transition-colors">२</button>
                <button className="w-10 h-10 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-primary-400 hover:text-primary-600 font-medium transition-colors">३</button>
                <button className="w-10 h-10 rounded-xl border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                  <ChevronRight className="w-5 h-5" />
                </button>
              </div>
...
const PRODUCTS = [
  ...
  { name: "উডেন অ্যাক্টিভিটি কিউব", price: "৳४५००", img: "bg-amber-100" },
  ...
  { name: "মিউজিক্যাল ম্যাট ফ্লোর পিয়ানো", price: "৳३५००", img: "bg-yellow-100" },
  { name: "জায়ান্ট টেডি বিয়ার হাগ", price: "৳३९९९", img: "bg-pink-100" },
  { name: "কিডস ডিজিটাল ক্যামেরা ১০৮०পি", price: "৳२९५०", img: "bg-cyan-100" },
  ...
  { name: "আরসি স্টান্ট কার ३६०", price: "৳२४९९", img: "bg-orange-100" },
