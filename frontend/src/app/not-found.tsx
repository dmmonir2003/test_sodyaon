    ...
    <Suspense fallback={null}>
      <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center px-4">
        <div className="text-center max-w-2xl mx-auto">
          {/* Large 404 heading */}
          <div className="mb-8">
            <div className="text-8xl md:text-9xl font-black bg-linear-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">
              404
            </div>
          </div>
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 mb-12">
            আমরা দুঃখিত! আপনি যে পেজটি খুঁজছেন তা আমাদের সার্ভারে পাওয়া যাচ্ছে
            না।
          </p>
