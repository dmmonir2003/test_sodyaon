      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12">
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-base font-bold">Google দিয়ে এক-ক্লিকে রেজিস্টার</span>
              </div>
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-sm">Facebook দিয়ে রেজিস্টার</span>
              </div>
          ...
          <div className="relative flex items-center mb-6">
            ...
            <span className="flex-shrink-0 px-4 text-slate-500 text-sm font-bold uppercase tracking-wider">অথবা ইমেইল</span>
            <div className="flex-grow border-t border-slate-200 dark:border-slate-800"></div>
          </div>
          ...
          <div className="flex bg-slate-100 dark:bg-slate-800/50 p-1 rounded-xl mb-6">
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2.5 text-sm font-bold rounded-lg transition-all ${registerMethod === "phone" ? "bg-white dark:bg-slate-700 shadow-sm text-primary-600 dark:text-primary-400" : "text-slate-400 hover:text-slate-600 dark:hover:text-slate-300"}`}
            >
